...
License:	GPL v2
Group:		Applications
Source0:	http://janosik.net/download/%{name}-%{version}.tar.gz
# Source0-md5:	14a7556b27fbf2c27728dc7850ad91a6
Patch0:		%{name}-API_path.patch
URL:		http://janosik.net/
...
Janosik jest wieloplatformowym odpowiednikiem programu Płatnik,
służącym do rozliczeń z Zakładem Ubezpieczeń Społecznych.
